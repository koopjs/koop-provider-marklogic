**The contents of this file were generated via the Koop CLI and are only being kept here for reference purposes.** 

For instructions on how to test this project, please see the CONTRIBUTING.md file in the root of this repository.
Otherwise, you can ignore the instructions below.
